...
def create_or_update_config_dir(main_dir: str, config_file: ConfigFile) -> None:
    """
...
class _ConfigDirSetup:
        ...
        for dir_name in self._non_config_dirs:
            ...
            for env_filename in list_of_envs_files:
                ...
                for line in file.unchanged_lines:
                    print(
                        f"WARNING: {line.strip()[:29]:30s} was not updated "
    ...
    def _substitute_info(self, file: EnvironmentFile, config_type: str) -> None:
        """
        ...
        for i, line in enumerate(file.lines):
            ...
            try:
                data = self.config_file.get_data_for(
                    dataname=key, element=fieldname, outer_element=config_type
                )
