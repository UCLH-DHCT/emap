...
public class ImpliedAdmissionTests extends MessageStreamBaseCase {
    ...
    public void testState() {
        ...
        List<PatientProperty> _arrivalTimes = bedVisit.getPropertyByAttribute(OldAttributeKeyMap.ARRIVAL_TIME);
        ...
        List<PatientProperty> _hospArrivalTimes = hospVisit.getPropertyByAttribute(OldAttributeKeyMap.ARRIVAL_TIME);
