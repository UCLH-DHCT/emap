...
/**
 * Controls interaction with patient Locations.
 * @author Stef Piatek
 */
@Component
public class PatientLocationController {
     ...
     * @param locationController     to get or create cached location from location string
     */
    public PatientLocationController(LocationVisitRepository locationVisitRepo,
                                     LocationVisitAuditRepository locationVisitAuditRepo, LocationController locationController) {
    ...
    public void processVisitLocation(HospitalVisit visit, AdtMessage msg, Instant storedFrom)
            throws RequiredDataMissingException, MessageCancelledException {
        ...
        Location locationEntity = locationController.getOrCreateLocation(msg.getFullLocationString().get());
    ...
    public void swapLocations(HospitalVisit visitA, HospitalVisit visitB, SwapLocations msg, Instant storedFrom)
        ...
        Location locationB = locationController.getOrCreateLocation(msg.getOtherFullLocationString().get());
        ...
        Location locationA = locationController.getOrCreateLocation(msg.getFullLocationString().get());
     ...
     * @throws MessageCancelledException if the message location has already been cancelled for the time
     */
    ...
    private void processDischargeMessage(
            ...
            throws MessageCancelledException, RequiredDataMissingException {
        if (locationVisitAuditRepo.messageLocationIsCancelled(visit, currentLocationId, msg.getDischargeDateTime(), true)) {
            throw new MessageCancelledException("Discharge has previously been cancelled");
        }
    ...
    private Optional<Location> getPreviousLocationId(AdtMessage msg) {
        ...
        if (msg.getPreviousLocationString().isSave()) {
            previousLocation = locationController.getOrCreateLocation(msg.getPreviousLocationString().get());
        }
