...
|| chr(13)
|| 'PID||9876543210|94006200^^^MRENTR^MEDREC||Da Vinci^Leonardo^Chuck^^Viscount||15000101|M|Chang|Z1|35 Gilbert Avenue^^Harlow^^CM1 5QT^^^Essex||020 7355 7255|Not Recorded||||3325008||||||||||||A'
|| chr(13)
